...
class DefaultPlayerUiControllerTV(
    private val youTubePlayerView: YouTubePlayerView,
    private val youTubePlayer: YouTubePlayer
) : PlayerUiController {

    //val rootView: View = View.inflate(youTubePlayerView.context, R.layout.custom_player_ui_2, null)
    val rootView: View = View.inflate(youTubePlayerView.context, com.pierfrancescosoffritti.androidyoutubeplayer.core.customui.R.layout.ayp_default_player_ui, null)
    ...
    var onVideoError: (PlayerConstants.PlayerError) -> Unit = {}
    ...
    override fun getMenu(): YouTubePlayerMenu? = null
    ...
    private fun updatePlayPauseButtonIcon(playing: Boolean) {
        val drawable = if (playing) com.pierfrancescosoffritti.androidyoutubeplayer.core.customui.R.drawable.ayp_ic_pause_36dp else com.pierfrancescosoffritti.androidyoutubeplayer.core.customui.R.drawable.ayp_ic_play_36dp
